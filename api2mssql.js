...
if ((args.s == undefined || args.d == undefined || args.u == undefined || args.p == undefined) && !args.default) {
...
var sql_username = args.u || 'goldfoun';
var sql_password = args.p || 'goldfoun20230424';
...
function log_info(message) {
  ...
  var logfile_name = "logs/log_information.txt";
...
function log_event(message) {
  ...
  var logfile_name = "logs/log_" + new Date().toISOString().substr(0, 10) + ".txt";
  // Check if the file exists
  if (!fs.existsSync(logfile_name)) {
    // Create the file if it doesn't exist
